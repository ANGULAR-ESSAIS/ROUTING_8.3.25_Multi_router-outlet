...
const routes: Routes = [
  ...
  { // Syntaxe URL : (M1_router_outlet_1:M2Module_compo0_in_M1Module_router_outlet_1)
    ...
    component: M2.Compo0Component,  // Sera donc chargé dans le <router-outlet> de name M1_router_outlet_1 (de M1Module).
    outlet: 'M1_router_outlet_1'
  },
  ...
  { // Syntaxe URL : (M1_router_outlet_1:M2Module_compo1_in_M1Module_router_outlet_1)
    ...
    component: M2.Compo1Component,  // Sera donc chargé dans le <router-outlet> de name M1_router_outlet_1 (de M1Module).
    outlet: 'M1_router_outlet_1'
  }
